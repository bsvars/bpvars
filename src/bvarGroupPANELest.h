#ifndef _BVARGROUPPANELEST_H_
#define _BVARGROUPPANELEST_H_
...
Rcpp::List bvarGroupPANELest(
    ...
    const bool                    estimate_groups = true // whether to estimate group-specific parameters
);


#endif  // _BVARGROUPPANELEST_H_
