...
2. The package includes the Gibbs sampler for a Bayesian Hierarchical Panel Vector Autoregression model. [#2](https://github.com/bsvars/bpvars/issues/2)
3. The package includes labour market dynamic panel data. [#3](https://github.com/bsvars/bpvars/issues/3)
4. The package includes the forecast method. [#5](https://github.com/bsvars/bpvars/issues/5)
...
6. The package includes estimation and forecasting with exogenous variables. [#12](https://github.com/bsvars/bpvars/issues/12)
7. The package includes forecast error variance decomposition analysis [#14](https://github.com/bsvars/bpvars/issues/14)
8. The package includes `plot` and `summary` routines [#17](https://github.com/bsvars/bpvars/issues/17)
