...
country grouping using the Gibbs sampler proposed by Sanchez-Martinez &
Woźniak (2024).
...
- specification:
  ...
  an object of class `PosteriorBVARGROUPPANEL` generated using the
...
or estimated country grouping is estimated using the Gibbs sampler. In
this estimation procedure all the parameters of the model are estimated
jointly. The list of parameters of the model includes:
