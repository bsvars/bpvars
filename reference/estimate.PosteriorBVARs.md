...
Estimates the Bayesian Hierarchical VARs for cubic data using the Gibbs
...
- specification:
  ...
  an object of class `PosteriorBVARs` generated using the
...
An object of class `PosteriorBVARs` containing the Bayesian estimation
...
- `posterior`:
  ...
  respectively: `A_c`, `Sigma_c`, `nu`, `m`, `w`, `s`.

- `last_draw`:

  an object of class `BVARs` with the last draw of the current MCMC run
...
parameters of the hierarchical VAR model listed above.
