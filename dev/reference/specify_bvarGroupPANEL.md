...
- [`bpvars::BVARPANEL$get_data_matrices()`](http://bsvars.org/bpvars/dev/reference/BVARPANEL.html#method-get_data_matrices)
- [`bpvars::BVARPANEL$get_prior()`](http://bsvars.org/bpvars/dev/reference/BVARPANEL.html#method-get_prior)
- [`bpvars::BVARPANEL$get_starting_values()`](http://bsvars.org/bpvars/dev/reference/BVARPANEL.html#method-get_starting_values)
- [`bpvars::BVARPANEL$get_type()`](http://bsvars.org/bpvars/dev/reference/BVARPANEL.html#method-get_type)
- [`bpvars::BVARPANEL$set_adaptiveMH()`](http://bsvars.org/bpvars/dev/reference/BVARPANEL.html#method-set_adaptiveMH)
- [`bpvars::BVARPANEL$set_to_Jarocinski()`](http://bsvars.org/bpvars/dev/reference/BVARPANEL.html#method-set_to_Jarocinski)
