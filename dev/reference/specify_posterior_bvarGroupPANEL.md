...
- [`bpvars::PosteriorBVARPANEL$get_last_draw()`](http://bsvars.org/bpvars/dev/reference/PosteriorBVARPANEL.html#method-get_last_draw)
- [`bpvars::PosteriorBVARPANEL$get_posterior()`](http://bsvars.org/bpvars/dev/reference/PosteriorBVARPANEL.html#method-get_posterior)
