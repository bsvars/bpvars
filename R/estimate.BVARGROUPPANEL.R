...
estimate.BVARGROUPPANEL <- function(
  ...
  # estimation
  qqq                 = .Call(`_bpvars_bvarGroupPANEL`, S, data_matrices$Y, data_matrices$missing, data_matrices$exogenous, prior, starting_values, thin, show_progress, adaptiveMH, estimate_groups, p)
